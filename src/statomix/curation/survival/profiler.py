"""Infer survival roles such as event, duration, and anchor dates."""
...
class SurvivalSemanticProfile:
    ...
    all_scores: Mapping[SurvivalDataTypes, float]
...
def get_survival_semantic_col_profile(
    col_name: str,
...
def get_survival_sematic_col_profile(
    col_name: str,
) -> SurvivalSemanticProfile:
    """Backward-compatible alias for the historically misspelled name."""

    return get_survival_semantic_col_profile(col_name=col_name)
