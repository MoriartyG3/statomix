"""Infer structural and semantic column profiles."""
...
class ColProfile:
    ...
    @classmethod
    def from_dict(cls, row: pd.Series | dict) -> ColProfile:
        return cls(
...
class SemanticProfile:
    ...
    all_scores: Mapping[DataTypes, float]
    ...
    def __post_init__(self) -> None:
        ...
        object.__setattr__(
            self,
            "all_scores",
            MappingProxyType(dict(self.all_scores)),
        )
...
class ColProfiler:
    ...
    def get_col_profile(self, col_name: str, col_series: pd.Series) -> ColProfile:
    ...
    @staticmethod
    def get_semantic_col_profile(col_name: str) -> SemanticProfile:

        scores: dict[DataTypes, float] = {}
