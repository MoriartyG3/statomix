...
class CatMetaReport:
    ...
    @staticmethod
    def _get_cat_edits(categorical_meta_df):
    ...
    def get_meta_edit_schema(self, curated_meta_report):
        ...
        cat_edits = self._get_cat_edits(categorical_meta_df=categorical_meta_df)
        ...
        #return MetaEditSchema(cat_edits=cat_edits, survival_meta=survival_meta)
