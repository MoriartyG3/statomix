...
class ColReport:
    ...
    def _create_col_report(self, report_path):
        ...
        with pd.ExcelWriter(path=report_path, engine="openpyxl") as writer:
            ...
            # Initialize Validation Metadata Sheet
    ...
    def _format_cell_length(self, report_path):
        ...
        for worksheet in workbook.worksheets:
            ...
            for column_cells in worksheet.columns:
                ...
                column_letter = get_column_letter(column_cells[0].column)  # Removed keyword 'column'
    ...
    def _add_validation_datatype(self, report_path):
        ...
        for worksheet in workbook.worksheets:
            ...
            # 1. Add Data Type Dropdown with Hard Input Restrictions (Column D)
            ...
            dv_datatype.add(f"D2:D{max_row}")

            # 2. Add Boolean Dropdown with Hard Input Restrictions (Column E)
    ...
    def _add_validation_categories(self, report_path, datatype):
        ...
        for cell in worksheet["A"][1:]:
            ...
            next_col_letter = get_column_letter(next_col_idx)  # Removed keyword 'column'
            ...
            # Informational reference drop down on Column A (No error restriction popup)
            ...
            dv_category.add(cell.coordinate)
    ...
    def _protect_worksheets(self, report_path):
        """
        Locks all cells on your output reports except for Column B (change_col_name)
        which remains open as free-text entry.
        """
        workbook = load_workbook(filename=report_path)
        ...
        for worksheet in workbook.worksheets:
            ...
            # Explicitly unlock Column B (change_col_name rows)
            # Row 1 is headers (remains locked), data starts at row 2
            for row in range(2, max_row + 1):
                cell = worksheet.cell(row=row, column=2) # Column 2 is B
                cell.protection = Protection(locked=False)

            # Turn on sheet protection structures
