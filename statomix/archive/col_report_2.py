...
class ColReport:
    ...
    def _add_validation_categories(self, report_path, datatype):
        ...
        for cell in worksheet["A"][1:]:
            ...
            # Validate against the new dynamic column range with strict input checking
            dv_category = DataValidation(
                ...
                error="The text you entered does not match any of the permitted custom categories.",
            )
