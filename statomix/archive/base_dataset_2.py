...
class BaseDataset:
    ...
    def create_col_report(
        ...
        if report_type == "default":
            ...
            default_col_report_meta = default_col_report_group.attrs.get("meta", {})
            ...
            base_path = BaseZARR.get_abs_path(zarr_group=default_col_report_group)
            report_path = base_path / f"version{version}_col_report.xlsx"
            profiles_path = base_path / f"version{version}_col_profile.parquet"
            ...
            default_col_report_group.attrs['meta'] = default_col_report_meta
    ...
    def process_col_report(self, version=None):
